...
public class ConnectedDevices implements Parcelable {
    ...
    public ConnectedDevices(@NonNull final ScanResult scanResult) {
    ...
    public boolean equals(final Object o) {
        if (o instanceof ConnectedDevices) {
            final ConnectedDevices that = (ConnectedDevices) o;
    ...
    private ConnectedDevices(final Parcel in) {
    ...
    public static final Creator<ConnectedDevices> CREATOR = new Creator<ConnectedDevices>() {
        @Override
        public ConnectedDevices createFromParcel(final Parcel source) {
            return new ConnectedDevices(source);
        }

        @Override
        public ConnectedDevices[] newArray(final int size) {
